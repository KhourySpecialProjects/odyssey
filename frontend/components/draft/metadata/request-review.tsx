  ...
  return (
    <>
      <button
        ...
        className="w-full rounded-full bg-orange-400 px-6 py-2 text-center whitespace-nowrap text-black hover:bg-orange-500 dark:bg-orange-600 dark:text-white dark:hover:bg-orange-800"
      >
