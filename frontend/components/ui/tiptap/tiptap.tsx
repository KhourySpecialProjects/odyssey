...
const Tiptap = ({
  ...
  if (
    (variant &&
      (variant == "lesson-callout" || variant == "lesson-expandable-body")) ||
        ...
        <div className="w-full border border-b-transparent rounded-t-md  border-slate-200 bg-white p-1 space-x-0.5">
          ...
          >
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="sc-bdvvtL sc-gGCDDS cYLxRJ ggfEtu"
            >
              <path
                fill="#32324D"
                fillRule="evenodd"
          ...
          >
            <svg
              ...
              fill="none"
              viewBox="0 0 24 24"
              className="sc-bdvvtL sc-gGCDDS dMoqVa kkJjHV"
            >
              <path
                fill="#32324D"
      ...
      <PopoverTrigger asChild disabled={disabled}>
        ...
        >
          <svg
            ...
            fill="none"
            viewBox="0 0 24 24"
            className="sc-bdvvtL sc-gGCDDS dUqgZq kkJjHV"
          >
            <path
              fill="#32324D"
              fillRule="evenodd"
