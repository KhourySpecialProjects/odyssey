...
describe('GenericBlockRenderer', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    (katex.renderToString as jest.Mock).mockImplementation((latex) => `<span>${latex}</span>`);
  });
  ...
  describe('LaTeX Processing', () => {
    ...
    it('should handle LaTeX processing errors', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Failed to render inline LaTeX:', expect.any(Error));
  ...
  describe('Code Block Processing', () => {
    it('should process code blocks with line numbers', () => {
      ...
      render(<GenericBlockRenderer {...defaultProps} block={blockWithCode} />);
    ...
    it('should remove plaintext language class', () => {
      ...
      render(<GenericBlockRenderer {...defaultProps} block={blockWithPlaintext} />);
  ...
  describe('Image Handling', () => {
    it('should handle image click and enlargement', () => {
      ...
      render(<GenericBlockRenderer {...defaultProps} block={blockWithImage} />);
