  ...
  return (
    <div className="w-full px-4 py-4 md:px-[56px] md:py-8">
      <div className="mt-4 mb-2 px-4 pt-4 pb-2">
        <div className="h-7 w-[120px] animate-pulse rounded bg-slate-200 md:h-9" />
        <div className="mt-2 h-4 w-[200px] animate-pulse rounded bg-slate-100 md:h-5 md:w-[320px]" />
      </div>
