...
export default async function AccessRequestBanner() {
  ...
  return (
    <>
      <div className="z-10 relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
        <div
        ...
        <div className="flex flex-wrap justify-center flex-grow w-full items-center gap-x-4 gap-y-2">
