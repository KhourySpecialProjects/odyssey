      ...
      <div className="px-6 isolate lg:px-8">
        ...
        <div className="max-w-2xl py-20 mx-auto sm:py-36 lg:py-44">
          <div className="text-center">
            <h1 className="text-4xl font-black dark:text-white tracking-tight text-slate-900 sm:text-6xl text-balance" role="heading">
            ...
            <div className="flex flex-col items-center justify-center mt-10 md:flex-row gap-x-6 gap-y-3">
              <Button
                size="lg"
                className="dark:bg-slate-800 dark:border dark:hover:text-black dark:border-slate-500 dark:text-white"
