...
export function Filter({ dropletId, initial, variant } : {dropletId: number, initial: string, variant: "focusArea" | "type"}) {
    ...
    return (
        <div>
            <h1 className="font-bold text-sm text-slate-900 pb-2">{variant == "focusArea" ? "Focus Area" : "Type"}</h1>
