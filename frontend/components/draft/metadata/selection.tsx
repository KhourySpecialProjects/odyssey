...
export function Selection({ dropletId, items, selectedItems, variant} : {dropletId: number, items: MultiSelectItem[], selectedItems: MultiSelectItem[], variant: "prerequisite" | "postrequisite" | "tag"}) {
    ...
    return (
        <>
            <MultiSelect label={uppercaseFirstChar(variant) + "s"} items={items} selected={selected} setSelected={update} align="start" className="w-full flex flex-row justify-around items-center"/>
