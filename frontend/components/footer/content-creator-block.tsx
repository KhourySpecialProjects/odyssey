  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className="flex justify-center pt-4">Email: {contentCreator.email}</div>
          {contentCreator.bio && <div className="flex justify-center pt-4">Bio: {contentCreator.bio}</div>}
        </div>
        </div>
        </li>
    </div>
