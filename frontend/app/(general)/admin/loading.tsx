function StatCardSkeleton() {
  return (
    <div className="h-auto min-h-[100px] animate-pulse rounded-[20px] bg-[#FCFCFD] shadow-[0px_0px_4px_0px_rgba(0,0,0,0.25)] md:h-[130px]">
      <div className="px-3 pt-3 md:px-[27px] md:pt-[14px]">
        <div className="h-4 w-[80px] rounded bg-slate-200 md:h-[18px] md:w-[120px]" />
        <div className="mt-2 h-7 w-[60px] rounded bg-slate-200 md:mt-[10px] md:h-[40px] md:w-[80px]" />
        <div className="mt-1 h-3 w-[100px] rounded bg-slate-200 md:mt-[8px] md:h-[16px] md:w-[140px]" />
      </div>
    </div>
  );
}
...
export default function AdminLoading() {
  return (
    <div className="w-full px-4 py-4 md:px-[56px] md:py-8">
      {/* Header skeleton */}
      <div className="mb-6">
        <div className="h-7 w-[100px] animate-pulse rounded bg-slate-200 md:h-[40px] md:w-[140px]" />
        <div className="mt-2 h-4 w-[240px] animate-pulse rounded bg-slate-100 md:h-[20px] md:w-[380px]" />
      </div>
