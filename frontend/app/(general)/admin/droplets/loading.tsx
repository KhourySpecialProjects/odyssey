...
export default function DropletsLoading() {
  return (
    <div className="w-full px-[56px] py-8">
      <div className="mt-4 mb-2 px-4 pt-4 pb-2">
        <div className="h-9 w-[120px] animate-pulse rounded bg-slate-200" />
        <div className="mt-2 h-5 w-[320px] animate-pulse rounded bg-slate-100" />
      </div>

      <div className="space-y-4">
        {/* Controls skeleton */}
        <div className="flex items-center justify-between">
          <div className="h-10 w-[818px] animate-pulse rounded-full bg-slate-200" />
          <div className="flex gap-2">
