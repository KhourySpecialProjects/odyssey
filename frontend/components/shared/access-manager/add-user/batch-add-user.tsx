        ...
        <div className="space-y-4">
          ...
          >
            ...
            <label
              ...
              className="inline-flex cursor-pointer items-center rounded-md border border-gray-300 bg-slate-100 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 shadow-sm transition duration-150 ease-in-out hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 dark:bg-slate-300"
            >
              Choose Files
            </label>
                ...
                {csvFiles.map((file, index) => (
                  <li key={index} className="mb-1 flex items-center space-x-2">
                    <button
                      ...
                      className="flex h-4 w-4 items-center justify-center rounded-full bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                    >
