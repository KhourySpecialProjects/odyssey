      ...
      <td className="h-[56px] px-6 py-[11px]">
        {group.semester ? (
          <Badge
            variant="outline"
            className={cn(
              "rounded-[16px] border-0 bg-[#f2f4f7] px-[9px] py-[4px] text-[14px] font-medium leading-[18px] text-[#60646c]",
            )}
          >
            {group.semester}
          </Badge>
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <FilterCheckboxGroup options={semesterOptions} selected={draftFilterSemesters} onToggle={toggleDraftFilterSemester} />
          </FilterButton>
        </div>
      </div>
