...
import { VoyagePublishButton } from "@/components/voyages/voyage-publish-button";
        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <div className="w-full shrink-0 lg:w-72">
            <div className="sticky top-8">
              {voyage.status === "draft" && (
                <span className="mb-2 inline-flex items-center rounded-[16px] bg-slate-200 px-[9px] py-[4px] text-xs leading-[18px] font-semibold text-slate-600 dark:bg-slate-600 dark:text-slate-300">
                  Draft
                </span>
              )}
              ...
              {isEnrolled && voyageNodes.length > 0 && (
                <div className="mt-3">
                  <VoyageProgressBar
                    completionPercentage={completionPercentage}
