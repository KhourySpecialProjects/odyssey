...
export function OpenEndedQuestionBlock({ question }: { question: OpenEndedQuizQuestion }) {
  console.log('Question type in OpenEndedQuestionBlock:', question);
  console.log('Has correctAnswer:', 'correctAnswer' in question);
