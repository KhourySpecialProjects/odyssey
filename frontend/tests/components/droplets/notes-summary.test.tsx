...
describe('NotesSummary', () => {
  ...
  it('shows empty state message when no notes or highlights', () => {
    ...
    expect(screen.getByText('You have no saved notes or highlights for this droplet.')).toBeInTheDocument()
  })
  ...
  it('groups notes and highlights by lesson', () => {
    const propsWithMultipleLessons = {
      ...mockProps,
      mappedLessons: [
        {
          id: 1,
