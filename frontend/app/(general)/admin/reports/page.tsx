            ...
            {Array.from({ length: 5 }).map((_, i) => (
              <tr key={i} className="border-b border-[#eaecf0]">
                ...
                <td className="h-[80px] px-6 py-3">
                  <div className="h-4 w-[280px] animate-pulse rounded bg-slate-200" />
                </td>
                <td className="h-[80px] px-6 py-3">
                ...
                <td className="h-[80px] px-6 py-3">
                  <div className="flex gap-[10px]">
                    <div className="h-[26px] w-[75px] animate-pulse rounded-[16px] bg-slate-200" />
                    <div className="h-[26px] w-[26px] animate-pulse rounded bg-slate-200" />
                  </div>
                </td>
              </tr>
            ))}
