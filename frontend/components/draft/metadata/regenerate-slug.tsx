...
export function RegenerateSlugButton({name,  dropletId }: {name: string, dropletId: number }) {
    const router = useRouter();

    const regenerateSlug = async (dropletId : number) => {
        const response = await updateDroplet(dropletId, {name: name}, {regenerateSlug: true});
