import {
  ...
  export default async function CantAccessRoute() {
    ...
    if (!user) {
      return (
        <Message>
          <MessageHeader subtitle="Access Required" title="Welcome to Khoury Odyssey" />
          <MessageDescription>
          ...
          <MessageActions>
            ...
            <Button size="lg" variant="outline" after={<ArrowRightIcon />} asChild>
    ...
    if (!authorizedUser) {
      return (
        <Message>
          ...
          />
          <MessageDescription>
            Thanks for your interest! While you&apos;re signed in, you&apos;ll need to request access
            to view this content. Join our growing community of learners today!
          </MessageDescription>
          <MessageActions>
            <Button size="lg" after={<ArrowRightIcon />} asChild>
              <Link href="/request-access">Request Access</Link>
