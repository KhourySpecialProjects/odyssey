...
describe("utils", () => {
  describe("fetchAPI", () => {
    ...
    it("should handle API errors", async () => {
      ...
      await expect(fetchAPI("test-endpoint", {})).rejects.toThrow("Failed to fetch data");
    });
  });
...
describe("utils", () => {
  ...
  describe("fetchAPI", () => {
    ...
    it("should make successful API call", async () => {
      const mockResponse = { 
        ok: true, 
        json: () => Promise.resolve({ data: { attributes: { test: "value" } } }) 
      };
    ...
    it("should handle API errors", async () => {
      ...
      await expect(fetchAPI("/test", {})).rejects.toThrow("Failed to fetch data");
    });
  });
  ...
  describe("role checks", () => {
    describe("isAuthorizedUserAdmin", () => {
      it("should return true for admin roles", () => {
        expect(isAuthorizedUserAdmin([AuthorizedUserRoleTitle.AcadAdmin])).toBe(true);
      });
...
describe("utils", () => {
  ...
  describe("condenseRoleTitles", () => {
    it("joins role titles with commas", () => {
      const roles = [AuthorizedUserRoleTitle.SysAdmin, AuthorizedUserRoleTitle.User];
