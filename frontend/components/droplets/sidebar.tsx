...
export default function Sidebar({
  ...
  const inactiveLinkClasses =
    "flex w-full items-center gap-3 rounded-xl px-3 py-2.5 transition-colors text-[#344054] hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800";
                ...
                <li className="w-full">
                  ...
                  >
                    <IconSearch
                      ...
                      stroke={1.8}
                    />
                    <span className="text-sm leading-none">Overview</span>
                  </Link>
                </li>
                    ...
                    return (
                      <li key={lesson.id} className="w-full">
                        ...
                        >
                          <span
                            className={cn(
                              "ml-1 h-4 w-px shrink-0 self-center rounded-full",
                              pathname === `/d/${droplet.slug}/${lesson.slug}`
                                ? "bg-[#287697] dark:bg-[#4AABCF]"
                ...
                <li className="w-full">
                  ...
                  >
                    <IconListCheck
                      ...
                      stroke={1.8}
                    />
                    <span className="text-sm leading-none">Recap</span>
                  </Link>
                </li>
              </ul>
            </div>
