...
describe("PlaylistList", () => {
  ...
  describe("Remove Functionality", () => {
    it("calls onRemove when remove button is clicked", () => {
      ...
      // Skip the up/down arrow buttons, get the remove button
    ...
    it("calls onRemove with correct playlist id", () => {
      ...
      // Find first remove button (skip arrow buttons)
      const removeButton = allButtons.find(
        (btn) => !btn.getAttribute("aria-label")?.includes("Move"),
      );
  ...
  describe("Reordering Functionality", () => {
    it("calls onReorder with reordered array", () => {
    ...
    it("reorders playlists correctly when moving from start to end", () => {
    ...
    it("reorders playlists correctly when moving from end to start", () => {
      const testPlaylists = mockPlaylists.slice(0, 3);
      const dragIndex = 2;
      const hoverIndex = 0;
    ...
    it("does not trigger reorder when hovering over same index", () => {
      ...
      // onReorder should not be called automatically
  ...
  describe("Arrow Button Functionality", () => {
    it("renders up and down arrow buttons for each playlist", () => {
      render(
        <PlaylistList
    ...
    it("disables up button for first playlist", () => {
      render(
        <PlaylistList
          playlists={mockPlaylists.slice(0, 3)}
          onReorder={mockOnReorder}
    ...
    it("disables down button for last playlist", () => {
      render(
        <PlaylistList
          playlists={mockPlaylists.slice(0, 3)}
          onReorder={mockOnReorder}
