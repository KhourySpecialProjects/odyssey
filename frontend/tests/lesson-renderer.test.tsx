...
//     fireEvent.click(screen.getByTestId('generic-block-1').querySelector('button:first-of-type'));
...
//     // Click the delete button in the generic block editor
//     fireEvent.click(screen.getByTestId('generic-block-1').querySelector('button:last-of-type'));
