...
test.describe("Academic Admin Navigation Tests", () => {
  ...
  test("Navigate To My Content", async ({ page }) => {
    ...
    await expect(
      page.getByRole("button", { name: "New Droplet" }),
    ).toBeVisible();
    await expect(
  ...
  test("Navigate To Review", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "To Review" }),
    ).toBeVisible();
    await expect(page.getByRole("main")).toContainText(
...
test.describe("Academic Admin Workflow Tests", () => {
  ...
  test("Academic Admin New Droplet Workflow", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Create a Droplet" }),
    ).toBeVisible();
    ...
    await expect(
      page.getByLabel("Focus Area *").locator("button"),
    ...
    await page
      .getByRole("option", { name: "Data Science" })
      .locator("div")
      .click();
    ...
    await page
      .getByRole("textbox", { name: "New Learning Objective..." })
      .click();
    await page
      .getByRole("textbox", { name: "New Learning Objective..." })
      .fill("To learn the objective");
    await page
      .getByRole("listitem")
      .filter({ hasText: /^$/ })
      .getByRole("button")
    ...
    await expect(
      page.getByRole("button", { name: "Create Droplet" }),
    ).toBeVisible();
  });
  test("Academic Admin New Playlist Workflow", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Create New Playlist" }),
    ).toBeVisible();
    await expect(page.getByText("Playlist Name *")).toBeVisible();
    await page
      .locator("div")
      .filter({ hasText: /^Make this playlist public$/ })
      .locator("div")
      .click();
    await expect(
      page
  ...
  test("Academic Admin Admin Stats Navigation", async ({ page }) => {
    ...
    await page
      .locator("div")
      .filter({ hasText: /^Daily Active Users$/ })
      .click();
    await page.goto(
      "https://dev.khouryodyssey.org/admin?statsTab=Daily+Active+Users",
    );
    await expect(page.locator("canvas")).toBeVisible();
    await expect(page.getByRole("main")).toContainText("Weekly Active Users");
    await page
      .locator("div")
      .filter({ hasText: /^Weekly Active Users$/ })
      .click();
    await expect(page.locator("canvas")).toBeVisible();
    await expect(page.getByRole("main")).toContainText(
    ...
    await page
      .locator("div")
      .filter({ hasText: /^Daily Unique Pageviews$/ })
      .click();
    await expect(page.locator("canvas")).toBeVisible();
    await page
      .locator("div")
      .filter({ hasText: /^General Statistics$/ })
      .click();
  ...
  test("Academic Admin Admin Users Navigation", async ({ page }) => {
    await page.goto("https://dev.khouryodyssey.org/admin");
    await expect(
      page.locator("div").filter({ hasText: /^Users$/ }),
    ).toBeVisible();
    await page
      .locator("div")
  ...
  test("Academic Admin Admin Droplets Navigation", async ({ page }) => {
    await page.goto("https://dev.khouryodyssey.org/admin");
    await expect(
      page.locator("div").filter({ hasText: /^Droplets$/ }),
    ).toBeVisible();
    await page
      .locator("div")
      .filter({ hasText: /^Droplets$/ })
      .click();
    await page.goto(
      "https://dev.khouryodyssey.org/admin?statsTab=General+Statistics&adminTab=Droplets",
    );
  ...
  test("Academic Admin Admin Groups Navigation", async ({ page }) => {
    ...
    await expect(
      page.locator("div").filter({ hasText: /^Groups$/ }),
    ).toBeVisible();
    await page
      .locator("div")
      ...
      .click();
    await page.goto(
      "https://dev.khouryodyssey.org/admin?statsTab=General+Statistics&adminTab=Groups",
    );
    await expect(page.getByRole("main")).toContainText("Groups");
  ...
  test("Academic Admin Admin Access Manager Navigation", async ({ page }) => {
    ...
    await expect(
      page.getByRole("heading", { name: "Batch Add Users" }),
    ).toBeVisible();
    await expect(page.getByText("Enter multiple email")).toBeVisible();
    await expect(
      page.getByRole("heading", { name: "Access Requests" }),
    ).toBeVisible();
  ...
  test("Academic Admin Admin Reports Navigation", async ({ page }) => {
    ...
    await page
      ...
      .click();
    await page.goto(
      "https://dev.khouryodyssey.org/admin?statsTab=General+Statistics&adminTab=Reports",
    );
    await expect(page.getByRole("main")).toContainText(
